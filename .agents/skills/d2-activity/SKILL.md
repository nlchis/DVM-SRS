...
> Họ skill D2: `/d2-activity` (flow này) · `/d2-erd` (data model) · `/d2-architect` (kiến trúc hệ thống). Cả 3 dùng chung `render.sh` ở `.agents/skills/d2-activity/`.
...
```bash
.agents/skills/d2-activity/render.sh docs/{feature}/d2/{slug}.d2
