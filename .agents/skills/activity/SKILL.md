...
9.7. **Inline Self-Review (CHỈ khi vượt ngưỡng phức tạp)** — Tự rà soát lại diagram (inline self-review) khi vượt bất kỳ ngưỡng nào: **≥3 lane** HOẶC **≥5 decision point** HOẶC **nesting decision ≥2 tầng** HOẶC có **loop/retry quay lại**.
   - Tự soi: Có thiếu lane không? Có nhánh cụt (dead-end) không?
   - Có BLOCKING → tự bổ sung lane/nhánh thiếu vào section, verify lại 9.5+9.6, rồi tiếp bước 10.
