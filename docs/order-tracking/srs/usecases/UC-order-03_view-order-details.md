# Đặc Tả Use Case: UC-order-03 - Xem chi tiết đơn hàng và theo dõi hành trình
...
│                                                            │
│ [ SỬA ĐƠN HÀNG ] [ IN PHIẾU & NHÃN ]   │
└────────────────────────────────────────────────────────────┘
```
*(Lưu ý: Nút [ SỬA ĐƠN HÀNG ] bị disable vì trạng thái đơn đã chuyển sang Đang Vận Chuyển, nút  bị disable vì chưa chuyển sang Thành Công).*
...
│ ├────────────────────────────────────────────────────────┤ │
│ │ SP-001   | Macbook Pro M3                | 01 chiếc    │ │
│ └────────────────────────────────────────────────────────┘ │
│                                                            │
