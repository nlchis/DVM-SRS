# Đặc Tả Use Case: UC-order-05 - Chỉnh sửa đơn hàng Chờ Duyệt
...
1. Sales truy cập trang Chi tiết Đơn hàng của một đơn hàng đang ở trạng thái **Chờ Phê Duyệt**.
...
4. Sales thực hiện sửa đổi các trường thông tin nhận hàng, hàng hóa, khối lượng, tiền COD hoặc tải lên file CO/CQ mới.
5. Sales nhấn nút **[Lưu]** trên popup.
6. Hệ thống thực hiện kiểm tra dữ liệu đầu vào. Dữ liệu hợp lệ, hệ thống tiến hành:
...
* **UC-order-05.EX.1: Dữ liệu nhập sai quy định**
  * Tại bước 6, nếu SĐT sai định dạng, thiếu trường bắt buộc, hoặc file CO/CQ vượt quá 5MB.
  * Hệ thống chặn lưu, giữ nguyên popup và hiển thị thông báo lỗi chi tiết tại các trường tương ứng trên form.
* **UC-order-05.EX.2: Xung đột thao tác đồng thời (Maker/Checker Race)**
  * Tại bước 5, khi Sales nhấn [Lưu] đúng lúc Admin vừa bấm Phê duyệt/Từ chối đơn hàng đó từ tài khoản của họ.
  * Hệ thống đối chiếu phiên bản dữ liệu và phát hiện phiên bản đã đổi. Hệ thống hủy giao dịch chỉnh sửa, đóng popup và báo lỗi: *"Đơn hàng đã được duyệt hoặc thay đổi bởi người khác. Vui lòng tải lại trang"*.
* **UC-order-05.EX.3: Tồn kho thực tế không đủ đáp ứng**
...
| 12 | File CO/CQ | Upload | N | Y | Đính kèm file CO/CQ của đơn hàng (tùy chọn). Dung lượng tệp phải ≤ 5 MB và có định dạng hỗ trợ là .pdf, .png, hoặc .jpg. |
